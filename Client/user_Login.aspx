<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_Login.aspx.cs" Inherits="Web_pages_Login" %>
...
<body>
    ...
    <br><br><br><br><br>
    <br>
    <h2 align="center" style="color:White; font-size:xx-large; font-family:Arial;"><b>Client Portal</b></h2>
<form class="box login" runat="server" >
	...
	<label><a href="Client_Registeration.aspx" class="btnLogin" tabindex="5">Not a Member</a></label>
	</footer>
</form>
</body>
</html>
